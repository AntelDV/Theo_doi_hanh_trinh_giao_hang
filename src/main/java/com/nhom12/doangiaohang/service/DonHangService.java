...
public class DonHangService {
 ...
 public DonHang taoDonHangMoi(DonHang donHang, Integer idDiaChiLayHang, Authentication authentication) {
     ...
     try {
         // RSAUtil mới sẽ sinh chuỗi ký chuẩn (không có \r\n)
 ...
 public void capNhatTrangThai(Integer idDonHang, Integer idTrangThaiMoi, String ghiChu, boolean daThanhToanCod, Authentication authentication) {
     ...
     if (idHienTai == 1 && idTrangThaiMoi == 2) isValidTransition = true;
     else if (idHienTai == 2 && idTrangThaiMoi == 4) isValidTransition = true;
     else if (idHienTai == 4 && (idTrangThaiMoi == 5 || idTrangThaiMoi == 6)) isValidTransition = true;
     else if (idHienTai == 6 && idTrangThaiMoi == 8) isValidTransition = true;
     else if (idHienTai == 8 && idTrangThaiMoi == 9) isValidTransition = true;
     else if (idHienTai == 7 && idTrangThaiMoi == 4) isValidTransition = true;
     
     if (idHienTai == 1 && donHang.getShipperHienTai() != null && idTrangThaiMoi == 2) isValidTransition = true;

     if (!isValidTransition) {
         throw new IllegalArgumentException("Lỗi Logic: Không thể chuyển trạng thái.");
     }
